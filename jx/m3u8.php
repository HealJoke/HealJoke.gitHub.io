...
<script>
    // 播放器基本设置
    var playlink ="<?php echo($_REQUEST['myurl']);?>",urlpar ='btjson';
    var dmapi = '//www.vivicms.cc/id/',vodurl = '<?php echo($_REQUEST['url']);?>',vodid="<?php echo($_REQUEST['name']);?>",vodsid="<?php echo($_REQUEST['sid']);?>",vodpic="<?php echo($_REQUEST['pic']);?>",vodname="<?php echo($_REQUEST['name']);?>",next = "<?php echo($_REQUEST['next']);?>",ym="http://www.djggg.com";
    ...
    //弹幕礼仪链接
    var dmrule = "https://www.laohutao.com/"
    //暂停广告
